...
public class Reader {
	 ...
	 */
	private List<Ingredient> tranformeChaineEnIngredients(String chaine) {
	 ...
	 */
	private List<Allergene> transformeChaineEnAllergenes(String chaine) {
	 ...
	 */
	private List<Additif> tranformeChaineEnAdditifs(String chaine) {
